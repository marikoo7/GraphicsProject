...
public class AA extends AnimListener implements MouseListener , MouseMotionListener{
    int maxWidth = 100;
    int mouseX;
    int mouseY;
    int maxHeight = 100;
...
//    boolean isDown2=false;
    ...
    String[] textureNames = { "frame_00_delay-0.08s.png","frame_01_delay-0.08s.png","frame_02_delay-0.08s.png","frame_03_delay-0.08s.png","frame_04_delay-0.08s.png","frame_05_delay-0.08s.png","frame_06_delay-0.08s.png","frame_07_delay-0.08s.png","frame_08_delay-0.08s.png","frame_09_delay-0.08s.png",
            ...
            "frame_60_delay-0.08s.png" ,"playerOne-1.png","playerOne-2.png","playerOne-3.png","playerOne-1.png","rock4.png","rock5.png","rock6.png","playerTwo-2.png","playerTwo-3.png","playerTwo-1.png","how-to-play.png","you-win.png","go-back-to-menu.png","instructions.png","start-game.png","select.png","one-player.png","two-players.png","exit.png","game-over.png","you-win.png",
            "T-ReX-GAME.png" ,"T-rexBG.png"
    }; //68 69 70
...
//             isDown1=true;
    ...
    public void DrawMenu(GL gl) {
        ...
        DrawSprite(gl, startGameX, startGameY, textures.length - 8, startGameScaleX, startGameScaleY);
        ...
        DrawSprite(gl, onePlayerX, onePlayerY, textures.length - 7, onePlayerScaleX, onePlayerScaleY);
        ...
        DrawSprite(gl, twoPlayersX, twoPlayersY, textures.length - 6, twoPlayersScaleX, twoPlayersScaleY);
        // Draw "Exit"
        int exitX = 45;
        ...
        DrawSprite(gl, exitX, exitY, textures.length - 5, exitScaleX, exitScaleY);
    ...
    public void displayGameOver(GL gl) {
        if(GameOver){
            DrawBackground(gl);

            DrawSprite(gl, 45, 50, textures.length-4, 0.7f, 0.2f); //  Game Over
    ...
    public void win(GL gl){
        if(score1==20){
            ...
            DrawSprite(gl, 45, 65, textures.length-3, 0.4f, 0.2f);
        }
    }
    @Override
